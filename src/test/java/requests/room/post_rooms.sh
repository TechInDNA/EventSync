...
curlie -k -b cookies.txt -s -w "\nHTTP Status: %{http_code}\n" -H "Content-Type: application/json" -d '{"name":"Main Hall"}' https://localhost:443/rooms
...
curlie -k -b cookies.txt -s -w "\nHTTP Status: %{http_code}\n" -H "Content-Type: application/json" -d '{"name":"Conference Room A"}' https://localhost:443/rooms

# Step 5: Missing name field (should return 400)
echo ""
echo "--- Test 4: Missing name field (should return 400) ---"
curlie -k -b cookies.txt -s -w "\nHTTP Status: %{http_code}\n" -H "Content-Type: application/json" -d '{}' https://localhost:443/rooms

# Step 6: Null name (should return 400)
echo ""
echo "--- Test 5: Null name (should return 400) ---"
curlie -k -b cookies.txt -s -w "\nHTTP Status: %{http_code}\n" -H "Content-Type: application/json" -d '{"name":null}' https://localhost:443/rooms

# Step 7: Empty name (should return 400)
echo ""
echo "--- Test 6: Empty name (should return 400) ---"
curlie -k -b cookies.txt -s -w "\nHTTP Status: %{http_code}\n" -H "Content-Type: application/json" -d '{"name":""}' https://localhost:443/rooms
...
curlie -k -b cookies.txt -s -w "\nHTTP Status: %{http_code}\n" -H "Content-Type: application/json" -d '{"name":"Room!123"}' https://localhost:443/rooms
...
curlie -k -b cookies.txt -s -w "\nHTTP Status: %{http_code}\n" -H "Content-Type: application/json" -d '{"name":"Room 101"}' https://localhost:443/rooms

# Step 13: Valid characters - with dot
echo ""
echo "--- Test 12: Name with dot (valid, should return 201) ---"
curlie -k -b cookies.txt -s -w "\nHTTP Status: %{http_code}\n" -H "Content-Type: application/json" -d '{"name":"Room.102"}' https://localhost:443/rooms

# Step 14: Valid characters - with comma
echo ""
echo "--- Test 13: Name with comma (valid, should return 201) ---"
curlie -k -b cookies.txt -s -w "\nHTTP Status: %{http_code}\n" -H "Content-Type: application/json" -d '{"name":"Hall A,B"}' https://localhost:443/rooms

# Step 15: Valid characters - with apostrophe
echo ""
echo "--- Test 14: Name with apostrophe (valid, should return 201) ---"
curlie -k -b cookies.txt -s -w "\nHTTP Status: %{http_code}\n" -H "Content-Type: application/json" -d '{"name":"Organizer'\''s Room"}' https://localhost:443/rooms
...
curlie -k -s -w "\nHTTP Status: %{http_code}\n" -H "Content-Type: application/json" -d '{"name":"Unauthorized Room"}' https://localhost:443/rooms

# Step 19: Test with very long name
echo ""
echo "--- Test 18: Very long name (should return 400) ---"
curlie -k -b cookies.txt -s -w "\nHTTP Status: %{http_code}\n" -H "Content-Type: application/json" -d '{"name":"VeryLongRoomNameThatMightExceedDatabaseConstraintsButLetsSeeWhatHappensWithThisStringWhichIsQuiteLong"}' https://localhost:443/rooms
