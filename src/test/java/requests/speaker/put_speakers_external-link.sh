...
curlie -k -X PUT -H "Content-Type: application/json" -d '{"name":"Portfolio","url":"https://portfolio.dev"}' "https://localhost:443/speakers/$WITH_LINKS_ID/external-link?urlName=Website"

# Step 3: Valid update of existing link (should return 200)
echo ""
echo "--- Test 2: Valid update of existing link (should return 200) ---"
curlie -k -X PUT -b cookies.txt -H "Content-Type: application/json" -d '{"name":"Portfolio","url":"https://portfolio.dev"}' "https://localhost:443/speakers/$WITH_LINKS_ID/external-link?urlName=Website"
...
curlie -k -X PUT -b cookies.txt -H "Content-Type: application/json" -d '{"name":"NewLink","url":"https://newlink.dev"}' "https://localhost:443/speakers/$WITH_LINKS_ID/external-link?urlName=NonExistent"

# Step 5: Update on speaker without external links (should return 404)
echo ""
echo "--- Test 4: Speaker without links (should return 404) ---"
curlie -k -X PUT -b cookies.txt -H "Content-Type: application/json" -d '{"name":"AnyLink","url":"https://anylink.dev"}' "https://localhost:443/speakers/$WITHOUT_LINKS_ID/external-link?urlName=Anything"
...
curlie -k -X PUT -b cookies.txt -H "Content-Type: application/json" -d '{"url":"https://missing-name.dev"}' "https://localhost:443/speakers/$WITH_LINKS_ID/external-link?urlName=Portfolio"

# Step 10: Missing url in body (should return 400)
echo ""
echo "--- Test 9: Missing url (should return 400) ---"
curlie -k -X PUT -b cookies.txt -H "Content-Type: application/json" -d '{"name":"Missing URL"}' "https://localhost:443/speakers/$WITH_LINKS_ID/external-link?urlName=Portfolio"

# Step 11: Empty name (should return 400)
echo ""
echo "--- Test 10: Empty name (should return 400) ---"
curlie -k -X PUT -b cookies.txt -H "Content-Type: application/json" -d '{"name":"","url":"https://empty-name.dev"}' "https://localhost:443/speakers/$WITH_LINKS_ID/external-link?urlName=Portfolio"

# Step 12: Blank name (spaces only, should return 400)
echo ""
echo "--- Test 11: Blank name (should return 400) ---"
curlie -k -X PUT -b cookies.txt -H "Content-Type: application/json" -d '{"name":"   ","url":"https://blank-name.dev"}' "https://localhost:443/speakers/$WITH_LINKS_ID/external-link?urlName=Portfolio"

# Step 13: Empty url (should return 400)
echo ""
echo "--- Test 12: Empty url (should return 400) ---"
curlie -k -X PUT -b cookies.txt -H "Content-Type: application/json" -d '{"name":"Empty URL","url":""}' "https://localhost:443/speakers/$WITH_LINKS_ID/external-link?urlName=Portfolio"

# Step 14: Name with invalid character '@' (should return 400)
echo ""
echo "--- Test 13: Name with invalid char '@' (should return 400) ---"
curlie -k -X PUT -b cookies.txt -H "Content-Type: application/json" -d '{"name":"Portfolio@Site","url":"https://invalid-char.dev"}' "https://localhost:443/speakers/$WITH_LINKS_ID/external-link?urlName=Portfolio"

# Step 15: Invalid URL format - ftp:// (should return 400)
echo ""
echo "--- Test 14: Invalid URL scheme ftp:// (should return 400) ---"
curlie -k -X PUT -b cookies.txt -H "Content-Type: application/json" -d '{"name":"FTP Link","url":"ftp://example.com"}' "https://localhost:443/speakers/$WITH_LINKS_ID/external-link?urlName=Portfolio"
...
curlie -k -X PUT -b cookies.txt -H "Content-Type: application/json" -d '{"name":"Portfolio","url":"https://testspeaker.dev"}' "https://localhost:443/speakers/$WITH_LINKS_ID/external-link?urlName=Portfolio"

# Step 17: Restore original link data for idempotency (should return 200)
echo ""
echo "--- Test 16: Restore original link (should return 200) ---"
curlie -k -X PUT -b cookies.txt -H "Content-Type: application/json" -d '{"name":"Website","url":"https://bobexternal.dev"}' "https://localhost:443/speakers/$WITH_LINKS_ID/external-link?urlName=Portfolio"
