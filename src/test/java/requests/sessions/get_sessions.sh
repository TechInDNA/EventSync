...
curlie -k -s -w "\nHTTP Status: %{http_code}\n" GET "https://localhost:443/sessions?eventTitle=Summer"
...
curlie -k -s -w "\nHTTP Status: %{http_code}\n" GET "https://localhost:443/sessions?eventTitle=Fall"
...
curlie -k -s -w "\nHTTP Status: %{http_code}\n" GET "https://localhost:443/sessions?roomName=Main"
...
curlie -k -s -w "\nHTTP Status: %{http_code}\n" GET "https://localhost:443/sessions?roomName=Workshop%20Room%20B"
...
curlie -k -s -w "\nHTTP Status: %{http_code}\n" GET "https://localhost:443/sessions?eventTitle=Summer&roomName=Workshop%20Room%20A"

# Test 19: Combined filters with pagination
echo ""
echo "--- Test 19: Filter by event=Fall + page=1&size=2 (2 of 3 sessions) ---"
curlie -k -s -w "\nHTTP Status: %{http_code}\n" GET "https://localhost:443/sessions?eventTitle=Fall&page=1&size=2"
...
curlie -k -s -w "\nHTTP Status: %{http_code}\n" GET "https://localhost:443/sessions?speakerName=Alice"
...
curlie -k -s -w "\nHTTP Status: %{http_code}\n" GET "https://localhost:443/sessions?eventTitle=Summer&speakerName=Jane"
...
curlie -k -s -w "\nHTTP Status: %{http_code}\n" GET "https://localhost:443/sessions?eventTitle=Fall&speakerName=Charlie"
...
curlie -k -s -w "\nHTTP Status: %{http_code}\n" GET "https://localhost:443/sessions?roomName=Main%20Hall&speakerName=John"
...
curlie -k -s -w "\nHTTP Status: %{http_code}\n" GET "https://localhost:443/sessions?eventTitle=Summer&isLive=true"
...
curlie -k -s -w "\nHTTP Status: %{http_code}\n" GET "https://localhost:443/sessions?speakerName=Jane&roomName=Workshop%20Room%20A"
