...
public class RoomService {
  ...
  public RoomService(
      RoomRepository roomRepository, DataValidator dataValidator, AuthService authService) {
  ...
  public Room updateRoomById(String id, RoomRequestDto request) {
    ...
    return roomRepository
        .updateRoomById(UUID.fromString(id), request.getName())
  ...
  public void deleteRoomById(String id) {
    dataValidator.validateUUID(id);
    roomRepository
        .deleteRoomById(UUID.fromString(id))
        .orElseThrow(() -> new NotFoundException(String.format("Room %s not found.", id)));
  }
}
