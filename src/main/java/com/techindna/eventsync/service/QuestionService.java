...
public class QuestionService {
  ...
  public GetQuestionListResponseDto getQuestionsBySessionId(
      String sessionId, String sort, PaginationRequestDto pagination) {
    ...
    return new GetQuestionListResponseDto(
        questionRepository.getQuestionsBySessionId(
            sid, sort, pagination.getOffset(), pagination.getLimit()),
  ...
  public int getUpvoteCount(String sessionId, String questionId) {
    ...
    sessionRepository
        .findSessionById(UUID.fromString(sessionId))
        .orElseThrow(
            () -> new NotFoundException(String.format("Session %s not found.", sessionId)));

    questionRepository
        .findQuestionByIdAndSessionId(UUID.fromString(questionId), UUID.fromString(sessionId))
        .orElseThrow(
            () -> new NotFoundException(String.format("Question %s not found.", questionId)));
